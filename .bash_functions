...
#==============================================================================
# Cross platform file browser opener
#==============================================================================
...
# `tree` command with hidden files and color enabled, ignoring dot-directories.
# The output gets piped into `less` with options to preserve color and line
...
function _completion_for_aliases() {
